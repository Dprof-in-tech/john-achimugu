...
const Footer = () => {
    return (
        <footer className="flex flex-col w-[100%] items-center justify-center p-4 bg-white text-black ">
            ...
            <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row w-[85%] lg:w-[50%] items-center justify-center space-x-8 p-4 text-black py-12 ">
                ...
                <a href=""><button className='border-solid border-gray-400 border-2 px-4 py-2  font-semi-bold text-[1.2rem] rounded-full w-[fit-content]'>+234-7156456787</button></a>
            </div>
